 ...
 * A mathematical graph-theory graph object G(V,E) 
 * contains a set V of vertices and a set
 * E of edges 
 ...
 * V and edges E of T 
 * Such a graph can contain vertices of type V and all sub-types 
 * and Edges of type E and all sub-types.
 */
public interface GraphInterface<V, E>
{
     ...
     * 
     * If weight greater than or equal to 1 it must be checked
	 ...
	 * As an example: if finding path from Vertex_1 to Vertex_10, the ArrayList of String
