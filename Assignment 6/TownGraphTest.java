	 ...
	 @Test
	  public void testTown_1ToTown_11() {
		  ...
		  if(beginIndex != null && endIndex != null)
		  {
			  ...
			  assertEquals("Town_1 via Road_1 to Town_2 2 miles",path.get(0).trim());
			  assertEquals("Town_2 via Road_12 to Town_11 6 miles",path.get(1).trim());
		  }
		  else
	  ...
	  public void testTown1ToTown_10() {
		  ...
		  if(beginIndex != null && endIndex != null)
		  {
			  ...
			  assertNotNull(path);
			  assertTrue(path.size() > 0);
			  assertEquals("Town_1 via Road_2 to Town_3 4 miles",path.get(0).trim());
			  assertEquals("Town_3 via Road_5 to Town_8 2 miles",path.get(1).trim());
			  assertEquals("Town_8 via Road_9 to Town_10 2 miles",path.get(2).trim());
		  }
		  else
			  fail("Town names are not valid");
	  ...
	  public void testTown_4ToTown_11() {
		  ...
		  if(beginIndex != null && endIndex != null)
		  {
			  ...
			  assertNotNull(path);
			  assertTrue(path.size() > 0);
			  assertEquals("Town_4 via Road_6 to Town_8 3 miles",path.get(0).trim());
			  assertEquals("Town_8 via Road_9 to Town_10 2 miles",path.get(1).trim());
			  assertEquals("Town_10 via Road_11 to Town_11 3 miles",path.get(2).trim());
		  }
		  else
			  fail("Town names are not valid");
