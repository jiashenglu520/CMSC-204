...
/**
 * An application for managing a map as a graph with the methods 
 * from manager class to access the towns and roads from state or national level,
 * modify the map with tasks such as adding or removing towns or routes, and 
 * determine whether towns or roads already exist in the current map.
 * @author: Jiasheng Lu
 */
